 ...
 *
 */
public class MeteredBar extends JPanel {
	private Color backGroundColor = Color.WHITE;
	private String labelText;
	private Dimension pnlPrefferedSize = new Dimension(235, 50);
	private Dimension lblPrefferedSize = new Dimension(65, 25);
	private Dimension prgPrefferedSize = new Dimension(150, 30);
	 ...
	 * @param border
	 */
	public MeteredBar(Color backGroundColor, String labelText, Dimension pnlPrefferedSize, Dimension lblPrefferedSize,
	...
	public MeteredBar(String labelText, int availableUnits, int unavailableUnits, int totalUnits, String nameUnit,
			String toolTip) {
