...
public class DebuggingObjectOutputStream extends ObjectOutputStream {
	...
	/**
	 * Indicates whether or not OOS has tried to write an IOException (presumably as
	 * the result of a serialization error) to the stream.
	 */
	...
	/**
	 * Returns a 0-based depth within the object graph of the current object being
	 * serialized.
	 */
