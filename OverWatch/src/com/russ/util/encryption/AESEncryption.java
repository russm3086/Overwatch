...
public class AESEncryption {
    ...
    /**
     * Creates a decrypted value of the given encrypted {@code String} using 
     * reverse content of the given {@code String} version of {@code SecretKey}.
     * 
     ...
     */
    public static String decryptTextRev(String encryptedText, String strKey) throws 
    ...
    /**
     * Creates a decrypted value of the given encrypted {@code String} using 
     * the given {@code String} version of {@code SecretKey}.
     * 
     * @param encryptedText				{@code String}
     ...
     * @throws Exception
     */
    public static String decryptText(String encryptedText, String strKey) throws 
    	InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, 
    	IllegalBlockSizeException, BadPaddingException {
     ...
     * @throws Exception
     */
    public static String decryptText(String encryptedText, SecretKey secKey) throws 
    	InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, 
    	IllegalBlockSizeException, BadPaddingException {
     ...
     * 			that cannot be determined from the given key, or if the given 
     * 			key has a keysize that exceeds the maximum allowable keysize 
     ...
     * @throws BadPaddingException
     */
    public static String encryptTextRev(String clearText, String strKey) throws 
    	InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, 
    	IllegalBlockSizeException, BadPaddingException {
     ...
     * @throws BadPaddingException
     */
    public static String encryptText(String clearText, String strKey) throws 
    	InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, 
    	IllegalBlockSizeException, BadPaddingException{
   ...
   /**
    * Returns the {@code String} representation of the {@code SecretKey} in 
    * reverse sequence.
    * 
    * @return {@code String}
    * @throws NoSuchAlgorithmException 
   ...
   public static String getSecretEncryptionKeyStrRev() throws NoSuchAlgorithmException{
     ...
     * 			KeyGeneratorSpi implementation for the specified algorithm.
     * 
     */
    ...
    /**
     * Returns the AES encryption key. In your actual programs, this should be safely
     * stored.
     * 
     * @return {@code SecretKey}
     * @throws NoSuchAlgorithmException if no Provider supports a 
