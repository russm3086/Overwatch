 ...
 *
 */
public class FUN_HostTableModel extends AbstractClusterNodeTableModel {
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public FUN_HostTableModel(HostQueue queue) {
		this(new ArrayList<Host>(queue.getHosts().values()), hostColumnNames.length);
	}

	public FUN_HostTableModel(HostQueue queue, int column) {
		this(new ArrayList<Host>(queue.getHosts().values()), column);
	}

	public FUN_HostTableModel(ArrayList<?> list) {
		super(list, hostColumnNames);
	}

	public FUN_HostTableModel(ArrayList<Host> list, int column) {
